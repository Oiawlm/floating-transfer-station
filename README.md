...
在 [1.8.2 统一发行版](https://github.com/Oiawlm/floating-transfer-station/releases/tag/v1.8.2) 选择你的平台：

| 平台 | 下载 | 状态 |
|---|---|---|
| Windows 11 x64 | [Windows 安装程序](https://github.com/Oiawlm/floating-transfer-station/releases/download/v1.8.2/FloatingTransferStation-Setup-1.8.2.exe) | 正式版 |
| Mac · Apple Silicon（M 系列芯片） | [Mac ARM64 ZIP](https://github.com/Oiawlm/floating-transfer-station/releases/download/v1.8.2/FloatingTransferStation-1.8.2-osx-arm64.zip) | 测试版，未 Apple 公证 |
...
解压 `FloatingTransferStation-1.8.2-osx-arm64.zip`，将 `FloatingTransferStation.app` 拖入“应用程序”。Mac 包使用临时签名，首次打开可能被 Gatekeeper 阻止；使用前请阅读下方的 Mac 验证与签名说明。
...
- **设置**：点击面板头部的齿轮按钮可打开设置窗口，调整主题（跟随系统/浅色/深色）、界面动效和开机自启，查看数据目录与版本信息，或退出应用；改动立即生效并自动保存。
