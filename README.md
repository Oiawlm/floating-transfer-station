...
在 [1.10.1 统一发行版](https://github.com/Oiawlm/floating-transfer-station/releases/tag/v1.10.1) 选择你的平台：

| 平台 | 下载 | 状态 |
|---|---|---|
| Windows 11 x64 | [Windows 安装程序](https://github.com/Oiawlm/floating-transfer-station/releases/download/v1.10.1/FloatingTransferStation-Setup-1.10.1.exe) | 正式版 |
| Mac · Apple Silicon（M 系列芯片） | [Mac ARM64 ZIP](https://github.com/Oiawlm/floating-transfer-station/releases/download/v1.10.1/FloatingTransferStation-1.10.1-osx-arm64.zip) | 测试版，未 Apple 公证 |
...
解压 `FloatingTransferStation-1.10.1-osx-arm64.zip`，将 `FloatingTransferStation.app` 拖入“应用程序”。Mac 包使用临时签名，首次打开可能被 Gatekeeper 阻止；使用前请阅读下方的 Mac 验证与签名说明。
